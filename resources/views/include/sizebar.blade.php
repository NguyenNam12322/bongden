        ...
        <aside id="nav_menu-3" class="widget widget_nav_menu"><span class="widget-title shop-sidebar">Danh mục sản phẩm</span>
            ...
            <div class="menu-menu-doc-container">
                <ul id="menu-menu-doc" class="menu">
                    <li id="menu-item-10450" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-10450 has-child" aria-expanded="false"><a href="#">SẢN PHẨM ĐÈN LED</a> 
                        <ul class="sub-menu">

                            <?php 

                                $groupProduct = App\Models\groupProduct::where('parent_id', 1)->select('link', 'name')->get();
                            ?>

                            @if(!empty($groupProduct))

                            @foreach($groupProduct as $value)
                            <li id="menu-item-5519" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-5519 has-child" aria-expanded="false"><a href="{{ route('details', $value->link)  }}">{{ $value->name  }}</a> 
